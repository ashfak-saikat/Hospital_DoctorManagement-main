...
@Component({
  ...
  templateUrl: './adminAmbulanceDetail.component.html',
  styleUrls: ['./adminAmbulanceDetail.component.scss']
})
export class AdminAmbulanceDetailComponent implements OnInit {
