...
public class BookingAppointmentController {
	...
	public ResponseEntity<BookingAppointment> saveRooms(@RequestBody BookingAppointment bookingAppointment){
		System.out.println("Booking Appointment Succesfull "+bookingAppointment);
		return new ResponseEntity<BookingAppointment>(bookingAppointmentService.saveBookingAppointment(bookingAppointment),HttpStatus.CREATED);
	}
